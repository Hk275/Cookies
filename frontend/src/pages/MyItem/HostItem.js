...
/**
 * This page are used for Hosts to view the item they create in reward system
 */
...
export default function HostItem() {
    ...
    // Get all listed items for the hosts
    React.useEffect(() => {
    fetch('http://127.0.0.1:5000/account/wallet/my_listed_items', requestoption)
    .then((r) => {
        if (r.status === 200) {
        r.json().then((data) => {
